 ...
 */
public class TabPageIndicatorGrey extends HorizontalScrollView implements PageIndicator {
    ...
    public TabPageIndicatorGrey(Context context) {
        this(context, null);
    }

    public TabPageIndicatorGrey(Context context, AttributeSet attrs) {
        super(context, attrs);
        setHorizontalScrollBarEnabled(false);

        mTabLayout = new IcsLinearLayout(context, R.attr.vpiTabPageIndicatorGreyStyle);
    ...
    protected class TabView extends TextView {
        ...
        public TabView(Context context) {
            super(context, null, R.attr.vpiTabPageIndicatorGreyStyle);
